...
Here's how to switch from Neon to [Supabase](https://supabase.com) for your `base-forge` project.
...
Now you can run the migration from the root of your `base-forge` project:
