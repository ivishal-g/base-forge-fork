...
Here's how to switch your base-forge project to use Hypertune for feature flags!

## 1. Create a new Hypertune project

Go to Hypertune and create a new project using the [base-forge template](https://app.hypertune.com/?new_project=1&new_project_template=base-forge). Then go to the Settings page of your project and copy the main token.
