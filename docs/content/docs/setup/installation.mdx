---
title: Installation
description: How to setup, install and run base-forge.
---

## Initialization

Run the `base-forge` init command:
...
┌  Let's start a base-forge project!
│
...
For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://www.base-forge.com/packages/database#default-configuration).
