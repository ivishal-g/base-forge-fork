...
description: How to configure environment variables in base-forge.
---

base-forge uses environment variables for configuration. This guide will help you set up the required variables to get started quickly, and optionally configure additional features.

## Quick Start (Minimum Setup)

To get base-forge running locally with basic functionality, you only need to configure these **required** variables:
...
<Step>
  Fork the [base-forge template](https://basehub.com/basehub/base-forge?fork=1) on BaseHub
</Step>
...
base-forge uses environment variables across multiple locations:
