---
title: App
description: How the main application works in base-forge.
---

<Tip>The `app` application runs on port 3000. We recommend deploying it to `app.{yourdomain}.com`.</Tip>

base-forge exports the main app from the `apps/app` directory. It is designed to be run on a subdomain of your choice, and is used to run the main user-facing application.
