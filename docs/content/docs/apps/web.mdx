---
title: Web
description: How the website application works in base-forge.
---

<Tip>The `web` application runs on port 3001. We recommend deploying it to `www.{yourdomain}.com`.</Tip>

base-forge comes with a default website application, which is located in the `apps/web` folder.
