---
title: Components
description: base-forge offers a default component library by shadcn/ui
---

base-forge contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
