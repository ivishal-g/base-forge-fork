...
export const VercelButton = () => {
  ...
  url.searchParams.set("demo-title", "base-forge");
  url.searchParams.set("demo-url", "https://www.base-forge.com/");
  url.searchParams.set(
    "env",
    [
      "DATABASE_URL",
  ...
  url.searchParams.set(
    "envLink",
    "https://www.base-forge.com/docs/setup/prerequisites"
  );
  url.searchParams.set("from", "templates");
  url.searchParams.set("project-name", "base-forge");
  url.searchParams.set("repository-name", "base-forge");
  url.searchParams.set(
    "repository-url",
    "https://github.com/vercel/base-forge"
  );
